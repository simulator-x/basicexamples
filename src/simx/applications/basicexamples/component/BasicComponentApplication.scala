 ...
 * (see [[simx.applications.basicexamples.component.ExampleComponent]] and
 * [[simx.applications.basicexamples.component.ExampleSphereAspect]])
 *
 * @author Dennis Wiebusch
 */
class BasicComponentApplication extends SimXApplication with JVRInit{
  ...
  protected def createComponents() {
    // create components
    create( new JVRConnector(rendererComponent))
    create( new ExampleComponent(exampleComponent))
  }
