...
/**
 * This application simulated the same scene as [[simx.applications.basicexamples.ExampleApplication]] but is a
            ...
            realize(
              ...
              realize(
                new EntityDescription(
                  SpotLight(
                    name = "light",
                    transformation = ConstMat4f(
                      Mat4x3f.rotateZ(functions.radians(0f)).rotateY(functions.radians(-25f)).rotateX(functions.radians(270f)).translate(Vec3f(-4f, 8f, -7f))
                    ),
...
object BareExampleApplication {
  ...
  def main( args : Array[String] ) {
    ...
    println( "--------------------------------------------------------------------------------" )
    val bareExampleApplication = SVarActor.createActor(new BareExampleApplication())
  }
