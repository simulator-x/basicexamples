...
import simx.core.components.renderer.createparameter.{PointLight, SpotLight}
 ...
 */
case class Light(name : String, pos : ConstVec3f, rot : ConstVec3f) extends EntityDescription(
    SpotLight(
      name           = name,
